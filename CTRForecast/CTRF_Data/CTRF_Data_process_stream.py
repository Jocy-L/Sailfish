...
def SteamRun():
    ...
    path_dir = 'E:\\Project\\CTRF\\Data\\Columns\\2023-05-18'
    ...
    if os.path.exists(trainning_file):
        ...
        rbf_svr_pred_true.to_excel(r'predict_items_float.xlsx', index=False)


    # 五、相关系数
    data = pd.read_excel('E:\\PythonProjects\\CTRForecast\\CTRF_Data\\predict_items_float.xlsx')
    # data = pd.read_csv('E:\\Project\\CTRF\\Data\\Columns\\2023-05-18\\Training.csv')
    # pd.set_option('display.max_columns', None)
    # pd.set_option('display.max_rows', None)
    # 禁止Dateframe自动换行(设置为Flase不自动换行，True反之)
    # pd.set_option('expand_frame_repr', False)
    print(data.corr())
    # print(data['预测值'].corr(data['真实值']))
